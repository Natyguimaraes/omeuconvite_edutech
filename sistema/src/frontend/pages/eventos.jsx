...
function Eventos() {
  ...
  // Funções modificadas para cálculo seguro
    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-purple-50 to-pink-50 py-16 px-4 sm:px-6 lg:px-8 pt-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-extrabold tracking-tight text-gray-800 mb-4 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {eventos.map((evento, index) => {
                    ...
                    console.log('Evento:', evento.id, {
                      ...
                      dadosConvidados: convidadosEvento
                    });

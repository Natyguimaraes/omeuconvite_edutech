                ...
                {eventos.length > 0 ? (
                  <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {eventos.map((evento) => {
                      ...
                      const totalConfirmados = getConfirmadosPorEvento(evento.id);
                          ...
                          <div className="relative px-4 sm:px-6 pt-4 sm:pt-6 pb-3 sm:pb-4">
                            ...
                            <div className="cursor-pointer group">
                              ...
                              <div className="grid grid-cols-4 gap-1 sm:gap-2 mb-3 sm:mb-4">
                                ...
                                <div className="flex flex-col items-center justify-center bg-gray-50 rounded-lg p-1 sm:p-2">
                                  <Heart className="h-3 sm:h-4 w-3 sm:w-4 text-green-500 mb-0 sm:mb-1" />
                                  <span className="text-xs font-medium text-gray-600">{totalConfirmados}</span>
                                  <span className="text-[10px] sm:text-xs text-gray-500">Confirm.</span>
                                </div>
                              </div>
